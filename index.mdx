...
Server, data, infra — engineers shouldn’t spend hours on admin UIs.\
...
<Card title="Get started" icon="rocket-launch" href="/kb/1000" cta="Build">
  Let's learn how to use Select Admin with YAML code examples.
</Card>