...
description: "Renders a table with clickable rows that open a modal populated from query-parameter data. Supports sharing, refreshing, and continuous viewing."
---
