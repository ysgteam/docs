...
description: "Renders table with clickable rows and opening a popup modal includes fetched data from query parameter. The page is ready for share, refresh, continuous view."
---

데이터베이스를 직접 연결하지 않고 쿼리 API를 호출하여 일반적인 테이블 표시, 클릭, 모달 표시, 상세 조회를 구성합니다.

![Screenshot 2025-11-18 at 4.48.59 PM.png](/images/Screenshot2025-11-18at4.48.59PM.png)

![Screenshot 2025-11-18 at 4.49.07 PM.png](/images/Screenshot2025-11-18at4.49.07PM.png)

![Screenshot 2025-11-18 at 4.49.13 PM.png](/images/Screenshot2025-11-18at4.49.13PM.png)
